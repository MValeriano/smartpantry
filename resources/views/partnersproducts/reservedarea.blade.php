...
<div class="col-lg-10 col-md-9 content d-flex justify-content-center align-items-center">
    <div class="card mb-4" style="width: 600px;">
        ...
        <div class="card-body">
            ...
            <p class="card-text">Desculpe, mas esta área está reservada aos administradores e parceiros autorizados apenas. Se você acredita que deveria ter acesso a este local, por favor, entre em contato conosco.</p>
        </div>
